...
/* @var $model backend\modules\app\models\appuserrefund\AppUserRefundRequest */
?>
<?php if (!Yii::$app->request->isAjax) {
$this->title = 'App User Refund Request';
$this->params['breadcrumbs'][] = ['label' => 'App User Refund Request', 'url' => 'index'];
...
<div class="app-user-refund-request-view">
