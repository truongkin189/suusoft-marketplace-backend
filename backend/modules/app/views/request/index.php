...
/* @var $searchModel backend\modules\app\models\AppUserTransactionRequestSearch */
...
?>
<div class="app-user-transaction-request-index">
    ...
    <div class="<?= $this->params['portletStyle'] ?>">
        <div class="portlet-title">
            <div class="caption font-dark">
                ...
                <?= 'App User Transaction Request'?></span>
