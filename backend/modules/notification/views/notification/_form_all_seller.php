...
<div class="notification-form">
    <div class="<?= $this->params['portletStyle'] ?>">
       ...
       <?= $form->field($model, 'message')->textarea(['rows' => 6])->label('Message to all seller') ?>

       <?= $form->field($model, 'buyer_all')->hiddenInput(['value' => 0])->label(false) ?>

       <?= $form->field($model, 'seller_all')->hiddenInput(['value' => 1])->label(false) ?>

       <?= $form->field($model, 'buyer_only')->hiddenInput()->label(false) ?>

       <?= $form->field($model, 'buyer_id')->hiddenInput()->label(false) ?>

       <?= $form->field($model, 'seller_only')->hiddenInput()->label(false) ?>

       <?= $form->field($model, 'seller_id')->hiddenInput()->label(false) ?>
