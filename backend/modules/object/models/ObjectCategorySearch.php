...
/**
 * ObjectCategorySearch represents the model behind the search form about `backend\modules\object\models\ObjectCategory`.
 */
class ObjectCategorySearch extends ObjectCategory
{
    ...
    {
        return [
            [['id', 'parent_id', 'sort_order', 'is_active', 'is_top', 'is_hot'], 'integer'],
    ...
    public function search($params)
    {
        ...
        // 10:08 22/8/19
        $query = ObjectCategory::find()->where(['IS','parent_id',null]);
    ...
    {
        $query = ObjectCategory::find()->where(['IS NOT','parent_id',null])->orderBy('parent_id ASC');
