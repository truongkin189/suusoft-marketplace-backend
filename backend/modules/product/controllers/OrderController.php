...
use backend\modules\product\models\OrderSearch;
use backend\modules\product\models\OrderDetailSearch;
...
class OrderController extends BackendController
{
    ...
    {
        $searchModel = new OrderSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Order::STATUS_WAITING);
    ...
    {
        $searchModel = new OrderSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Order::STATUS_REJECTED);
    ...
    {
        $searchModel = new OrderSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Order::STATUS_DELIVERIED);
    ...
    {
        $searchModel = new OrderSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Order::STATUS_PAID);
    ...
    {   
        ...
        $params['OrderDetailSearch']['orderId'] = $id;
