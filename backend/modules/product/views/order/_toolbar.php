...
$bulkActionButton = '<div class="dropdown pull-left">&nbsp;<button class="btn btn-default" data-toggle="dropdown">'. FHtml::t('common', 'Actions'). '</button>' .
    DropdownX::widget([
        'items' => \yii\helpers\ArrayHelper::merge(
                                    [FHtml::buildBulkActionsMenu(FHtml::CHANGE_TYPE, FHtml::t('common', 'Set'). ' '. FHtml::t('common', 'Status'), 'order', 'status')],
                        ['<li class="divider"></li>'],
                        //[FHtml::buildBulkActionsMenu(FHtml::CLEAR_TYPE, ucwords(FHtml::CLEAR_TYPE). ' '. FHtml::t('common', 'Amount'), 'backend\modules\product\models\Order', 'amount')],
            //[FHtml::buildBulkActionsMenu(FHtml::FILL_TYPE, ucwords(FHtml::FILL_TYPE). ' '. FHtml::t('common', 'Amount'), 'backend\modules\product\models\Order', 'amount')],
            //['<li class="divider"></li>'],
